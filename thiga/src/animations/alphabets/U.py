...
def get_animation():
    return [
        [
            ...
            ('mixamorigLeftHand', 'x', math.pi/1.45),
            ('mixamorigLeftHand', 'z', math.pi/6),
            ('mixamorigLeftHand', 'y', math.pi/36),
            ...
            ('mixamorigRightHand', 'y', math.pi/15),
            ('mixamorigRightForeArm', 'z', math.pi/6),
            ('mixamorigRightForeArm', 'x', -math.pi/36),
            ('mixamorigRightArm', 'x', -math.pi/13),
            ('mixamorigRightArm', 'y', math.pi/18),
        ],
        [
