...
def get_animation():
    return [
        [
            ...
            ('mixamorigLeftForeArm', 'x', math.pi/10),
            ('mixamorigLeftForeArm', 'z', -math.pi/18),
            ('mixamorigLeftArm', 'x', -math.pi/11),
            ...
            ('mixamorigRightForeArm', 'z', math.pi/4),
            ('mixamorigRightForeArm', 'x', -math.pi/36),
            ('mixamorigRightArm', 'x', -math.pi/9),
            ('mixamorigRightArm', 'y', -math.pi/72),
        ],
        [
