...
function Videos() {
  ...
  return (
    <div className="container-fluid d-flex flex-column align-items-center px-0 page-container-cream">
      <div className="container-fluid text-white brown-header">
      ...
      <section id="create-video">
        <div className="container">
          <div className="row my-4">
            ...
            >
              <div className="h2 section-heading-brown">Create a new video!</div>
              <div className="col-lg-4 divider-brown my-2" />
              ...
              <Link to='/sign-kit/create-video' className="btn btn-brown mt-4">
        ...
        <div className="container">
          <div className="row mt-3">
            <div
              ...
              style={{ flexDirection: "column" }}
            >
              <div className="h2 section-heading-brown">Open a video</div>
              <div className="col-lg-4 divider-brown my-2" />
              <div className="text-center normal-text">
      ...
      <Row className="container mb-3">
        ...
        >
          ...
          <Button type="submit" className="my-2 btn-brown">
            Open Video
          </Button>
        </Form>
      </Row>
        ...
        <div className="container">
          <div className="row mt-3">
            <div
              ...
              style={{ flexDirection: "column" }}
            >
              <div className="h2 section-heading-brown">Your Video Feed</div>
              <div className="col-lg-4 divider-brown my-2" />
              <div className="text-center normal-text">
