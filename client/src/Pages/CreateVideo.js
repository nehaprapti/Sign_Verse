...
function CreateVideo() {
  ...
  return (
    <div className="container d-flex flex-column align-items-center page-container-cream">
      <div className="display-5 mt-5 px-2 text-center brown-text">Create a New Video!</div>
      ...
      <Row className="container">
        ...
        >
          ...
          {mode === "speech" && (
            <div className="col-md-7 d-flex flex-column justify-content-center my-3">
              <div className="row d-flex justify-content-center">
                ...
                <button
                  type="button"
                  className="btn btn-brown col-md-3 mx-3"
          ...
          <Button type="submit" className='mt-3 btn-brown'>Submit form</Button>
        </Form>
      </Row>
