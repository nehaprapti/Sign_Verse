    ...
    <div className='container-fluid page-container-cream'>
      <div className='row'>
        <div className='col-md-3'>
          ...
          <button onClick={animateFromID} className='btn btn-brown w-100 btn-style btn-start mb-3'>
              Start Video
          </button>
          <hr />
          {title && 
      ...
      <Modal show={invalidId} onHide={() => setInvalidId(false)}>
        <Modal.Header closeButton className="brown-header">
          <Modal.Title>Invalid Video ID</Modal.Title>
        </Modal.Header>
        <Modal.Body className="cream-light-bg">Please make sure that the video ID that your have entered is valid!</Modal.Body>
        <Modal.Footer className="cream-light-bg">
          <Button className="btn-brown" onClick={() => setInvalidId(false)}>
            Close
          </Button>
        </Modal.Footer>
      </Modal>
