...
function Feedback() {
  return (
    <div className="container-fluid d-flex flex-column align-items-center px-0 page-container-cream">
      <div
        className="container-fluid text-white brown-header"
      >
      ...
      <div className="container row d-flex justify-content-between">
        ...
        <div className="card card mb-3 col-md-5 p-0 border border-brown">
          <div className="card-header text-center brown-header">
      ...
      <div className="container row d-flex justify-content-between">
        <div className="card card col-md-5 p-0 border border-brown">
          <div className="card-header text-center brown-header">
