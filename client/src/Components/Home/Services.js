...
function Services() {
  return (
    <section id="services" className="page-container-cream">
      <div className="container">
        <div className="row mt-5">
          ...
          >
            <div className="h2 section-heading-brown">Our Services</div>
        ...
        <div className="card-deck">
          <div className="row">
            <div className="col-lg-4 mt-5">
              <div className="card col-lg-12 h-100 d-flex flex-column justify-content-between card-background">
                ...
                <div className="card-footer p-0 m-0" style={{ border: "none" }}>
                  <Link
                    to="/sign-kit/convert"
                    className="btn btn-brown w-100 p-3"
            ...
            <div className="col-lg-4 mt-5">
              <div className="card col-lg-12 h-100 d-flex flex-column justify-content-between card-brown">
